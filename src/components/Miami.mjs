...
export function generalScript(allPlaces) {
  ...
  async function handleMap() {
        ...
        function (results, status) {
          if (status === window.google.maps.GeocoderStatus.OK) {
            if (results[1]) {
              ...
              const star = `<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" class="place-info-star"><style>svg{fill:#ffde0a}</style><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>`;
              const halfStar = `<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" class="place-info-star"><style>svg{fill:#ffde0a}</style><path d="M288 0c-12.2 .1-23.3 7-28.6 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3L288 439.8V0zM429.9 512c1.1 .1 2.1 .1 3.2 0h-3.2z"/></svg>`;
                ...
                if (
                  ...
                  function placeInfoHome() {
                    ...
                    placeInfo.innerHTML =
                      ...
                      category +
                      `</h4>` +
                      `<div id="placeinfo-nav"><button>Overview</button><button id="show-me-reviews" placeId="${id}" overallRating="${place.rating}">Reviews</button></div>` +
                      `<p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="place-info-icon"><path d="M384 192c0 87.4-117 243-168.3 307.2c-12.3 15.3-35.1 15.3-47.4 0C117 435 0 279.4 0 192C0 86 86 0 192 0S384 86 384 192z"/></svg> ${place.formatted_address}</p>` +
                      `<p id='placePhone'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="place-info-icon"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg> ${place.formatted_phone_number}</p>` +
                      `<div id="dropdown3">` +
                      `<p class="todays-hours"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="place-info-icon"><path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg> ${todaysHours}</p>` +
                      `</div>` +
                      `<br>` +
                      `<div id="APPEND_HERE">
    ...
    let chevron = `<svg xmlns="http://www.w3.org/2000/svg" height="0.8em" viewBox="0 0 320 512" class="black-svg"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>`;
