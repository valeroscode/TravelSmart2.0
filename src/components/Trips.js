        ...
        <div id="your-trips">
          ...
          <ul id="trips-con" ref={unorderedList}>
            {info !== undefined ? (
              ...
              <li>
                <div style={{ fontSize: "1.5rem" }}><p style={{color: "white", margin: "0"}}>No trips planned right now</p><button style={{width: "fit-content", fontWeight: 800, color: "white", backgroundColor: "#8A05FF", height: "100%", fontFamily: "'Roboto Condensed', sans-serif", padding: "1rem", fontSize: "1.25rem"}}>Start Planning</button></div>
              </li>
            )}
          </ul>
        </div>
